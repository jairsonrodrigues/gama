...
```{r, message = FALSE, echo=FALSE}
set.seed(42)
obj <- gama(dataset = aggregation, k = 7, generations = 1000, plot.internals = FALSE, fitness.criterion = "DI")
gama.plot.partitions(obj)
```
...
obj <- gama(path.based, k = best.k, plot.internals = FALSE)
gama.plot.partitions(obj)
```

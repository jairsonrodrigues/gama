...
obj <- gama(data = cpu.als, penalty.function = my.penalty, generations = 500, seed.p = 42)
...
```{r, message = FALSE, echo=FALSE}
obj <- gama(compound, k = 6, generations = 500, plot.internals = FALSE, fitness.criterion = "CH", seed.p = 42)
gama.plot.partitions(obj)
```
...
```{r, message = FALSE, echo=FALSE}
obj <- gama(dataset = aggregation, k = 7, generations = 500, plot.internals = FALSE, fitness.criterion = "DI", seed.p = 42)
gama.plot.partitions(obj)
```
